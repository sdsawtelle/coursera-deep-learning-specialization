...
def compute_layer_style_cost(a_S, a_G):
    ...
    J_style_layer = 1/(4*(n_H*n_W*n_C)**2)*tf.reduce_sum(tf.squared_difference(GS, GG))
...
generated_image = generate_noise_image(content_image)  # Initialize generated image
...
J = total_cost(J_content, J_style, alpha=10, beta=40)  # Extend the graph computation
